  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myJhipsterApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="myJhipsterApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('myJhipsterApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('myJhipsterApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('myJhipsterApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
