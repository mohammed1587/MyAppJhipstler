...
export const Job = (props: IJobProps) => {
  ...
  const { jobList, match, totalItems } = props;
  return (
    <div>
      <h2 id="job-heading">
        <Translate contentKey="myJhipsterApp.job.home.title">Jobs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="myJhipsterApp.job.home.createLabel">Create new Job</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {jobList && jobList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('jobTitle')}>
                  <Translate contentKey="myJhipsterApp.job.jobTitle">Job Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('minSalary')}>
                  <Translate contentKey="myJhipsterApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maxSalary')}>
                  <Translate contentKey="myJhipsterApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="myJhipsterApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="myJhipsterApp.job.home.notFound">No Jobs found</Translate>
          </div>
        )}
      </div>
