...
export const Task = (props: ITaskProps) => {
  ...
  return (
    <div>
      <h2 id="task-heading">
        <Translate contentKey="myJhipsterApp.task.home.title">Tasks</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="myJhipsterApp.task.home.createLabel">Create new Task</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {taskList && taskList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myJhipsterApp.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="myJhipsterApp.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="myJhipsterApp.task.home.notFound">No Tasks found</Translate>
          </div>
        )}
      </div>
    </div>
