  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myJhipsterApp.country.home.createOrEditLabel">
            <Translate contentKey="myJhipsterApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="country-region">
                  <Translate contentKey="myJhipsterApp.country.region">Region+6+6+6+</Translate>
                </Label>
                  ...
                  {regions
                    ? regions.map(otherEntity => (
                        <option value={otherEntity.id} key={otherEntity.id}>
                          {otherEntity.regionName} dsqdsqdsq
                        </option>
                      ))
                    : null}
                </AvInput>
