...
export const CountryDetail = (props: ICountryDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="myJhipsterApp.country.detail.title">Country</Translate> [<b>{countryEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="countryName">
              <Translate contentKey="myJhipsterApp.country.countryName">Country Namedfffffffffffffff</Translate>
            </span>
          </dt>
